本文前篇幅**前篇部分**我写了下我今天配置的时候遇到的一个小问题，直接讲了重点，然后**原理部分**，参考<https://www.cnblogs.com/frankb/p/7427944.html>，而且这篇文章的命令详解也很详细，但是我觉得我看起来，不那么直观的感觉，有兴趣的可以点进去看一下。而我**最后命令详解的部分**，参考其他文章，随便列举了几个命令，不一一列举
