...
explain select * from medicalrecordindexs where relationshipid  = 1  or relatedobjid  =1
```
...
explain select * from medicalrecordindexs where relationshipid  = 1  or relatedobjid  =2 or isdelete=0
```
