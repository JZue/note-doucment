...
```
select count(*) as count ,patientid from medicalrecordindexs group by patientid order by count limit 10  
filesort 
...
curl http://127.0.0.1:8000/MedicalRecordService/getMedicalRecordInfoById?id=8801930909&userId=1916409&role=patient
```
